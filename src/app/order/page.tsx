            ...
            {order.status === "pending" && order.payment_wallet && (
              <div className="border-t border-[#2a2a2a] pt-3 mt-3">
                <div className="flex justify-between items-center mb-2">
                  <p className="text-[11px] text-[#777]">Kirim pembayaran ke:</p>
                  <button
