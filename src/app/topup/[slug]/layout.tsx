...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Top up ${game.name} harga termurah. ${game.description}. Proses cepat 3-5 menit. Bayar pakai Crypto, QRIS, atau Bank Transfer. Aman & terpercaya.`;
...
export default function TopUpLayout({ params, children }: Props) {
  ...
  const productSchema: Record<string, unknown> = {
    ...
    description: `Top up ${game.name} harga termurah. ${game.description}. Proses cepat 3-5 menit.`,
