...
const faqData = [
  {
    ...
    a: "Pilih game yang ingin di-top up, masukkan User ID, pilih nominal, lalu pilih metode pembayaran. Proses otomatis 3-5 menit setelah pembayaran dikonfirmasi.",
  },
  {
  ...
  },
  {
    ...
    a: "Proses top up otomatis dalam 3-5 menit setelah pembayaran terverifikasi. Untuk pembayaran crypto, konfirmasi tergantung kecepatan blockchain (biasanya 1-5 menit).",
  },
  {
