        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-2">
              ...
              <a href="https://wa.me/6285157434365" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#2a2a2a] p-2 text-[#777] hover:text-[#c8a45c] transition-colors">
              ...
              <a href="https://t.me/NyinyiStore_bot" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#2a2a2a] p-2 text-[#777] hover:text-[#c8a45c] transition-colors">
