        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-2">
              <a href="https://instagram.com/nyinyistore" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#2a2a2a] p-2 text-[#777] hover:text-[#d4af37] transition-colors">
              ...
              <a href="https://wa.me/6285157434365" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#2a2a2a] p-2 text-[#777] hover:text-[#d4af37] transition-colors">
              ...
              <a href="https://t.me/NyinyiStore_bot" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#2a2a2a] p-2 text-[#777] hover:text-[#d4af37] transition-colors">
          ...
          {/* Peta Situs */}
          <div>
            <h3 className="mb-3 text-xs font-semibold text-[#d4af37] uppercase tracking-wider">Peta Situs</h3>
          ...
          {/* Dukungan */}
          <div>
            <h3 className="mb-3 text-xs font-semibold text-[#d4af37] uppercase tracking-wider">Dukungan</h3>
            <ul className="space-y-2 text-xs text-[#777]">
          ...
          {/* Payment Methods */}
          <div>
            <h3 className="mb-3 text-xs font-semibold text-[#d4af37] uppercase tracking-wider">Metode Pembayaran</h3>
